...
Wenn du Musik beisteuern willst, tritt direkt über die Foren in Kontakt:

- Nutze das **Maniac Mansion Mania-Community-Forum** für öffentlichen Austausch und Einstieg.
- Nutze die **Night of the Meteor-Forenbereiche** (Deutsch/Englisch) für projektbezogene Abstimmung.

Der beste nächste Schritt ist ein kurzer Post mit deiner Idee, dem geplanten Ingame-Einsatz und einem groben Demo-Link.
...
| [Beispiele für Cues](writing-to-arranging-example.md) | Zwei Demos zeigen, wie ein roher Writing-Cue im Arranging erweitert werden kann. |
...
*Diese Seite wird aus dem Doku-Repository `nm-tutorials` gebaut; klone oder forke das Repo, wenn du Änderungen vorschlagen willst.*
